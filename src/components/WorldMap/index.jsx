...
import worldMapSvg from "../../assets/maps/map-world.svg";
...
<svg
   ...
   xmlns:dc="http://purl.org/dc/elements/1.1/"><metadata
     ...
     id="mexico"
     class="eastern-pacific"
     title="Oceano pacífico Tropical Oriental: 10 países"
     ...
     id="egypt"
     class="red-sea"
     title="Mar Vermelho e Golfo de Aden"
     ...
     id="sudan"
     class="red-sea"
     title="Mar Vermelho e Golfo de Aden" /><path
     id="cameroon"
     ...
     id="somaliland"
     class="western-indian"
     title="Oceano Índico Ocidental: 10 países"
     ...
     id="maldive"
     class="south-asia"
     title="Sul da Ásia: 6 países e o arquipélago de Chagos"
     ...
     id="guadeloupe"
     class="caribbean"
     title="Caribe: Países do Caribe e Golfo do México"
     ...
     id="iran"
     class="ropme"
     title="ROPME: 8 nações membros da ROPME"
...
`;
      ...
      // Sanitize the SVG text
      const cleanSvgText = DOMPurify.sanitize(svgText, { USE_PROFILES: { svg: true } });
